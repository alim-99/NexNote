  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-[calc(100vh-64px)] px-6">
      <section className="max-w-3xl text-center space-y-6 py-32">
        <h1 className="text-4xl sm:text-5xl font-extrabold leading-14 tracking-tight">
          <strong className="text-indigo-600">Capture</strong> ideas, Organize thoughts, <strong className="text-indigo-600">Summarize</strong> with AI
        </h1>
